...
<body>
    <div style="background-color:#E0E0E0; "><h2 style="text-align: center; padding-top: 5px; padding-bottom: 5px;">Result Analytics</h2></div>
        
    <!-- overall result by student -->
    <div><h2 style="margin-left: 60px;">Overall Result by Student Id</h2></div> 
    <div style=" overflow: hidden; margin: 15px auto; max-width: 600px; "> 
    ...
    <div style=" overflow: hidden; margin: 15px auto; max-width: 800px;"> 
     ...
     <iframe scrolling="no" src="https://app.powerbi.com/reportEmbed?reportId=f6153308-0833-482e-ac37-9ec75c5ef236&autoAuth=true&ctid=0869d2b7-957f-41e6-b98e-69d3ddc9fe06&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly93YWJpLWVhc3QtYXNpYS1iLXByaW1hcnktcmVkaXJlY3QuYW5hbHlzaXMud2luZG93cy5uZXQvIn0%3D&pageName=ReportSection6f573dea300a4328b369&$filter=result/SID eq '1002'" style="border: 0px none; marign-top: 75px; margin-left: -30px; height: 859px; margin-bottom: -420px; margin-right: -120px; width: 890px;">
        </iframe>
    </div>
    <!-- course wise result -->
